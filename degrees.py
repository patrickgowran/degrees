...
def shortest_path(source, target):
    ...
    # In the beginning, the solution has not been found,
    # and it is not known whether a solution exists or not
    solution_found = False
    no_solution = False
    solution = list()

    # Start with a frontier that contains the initial state
    # Breadth-First-Search uses queue data type
    ...
    while solution_found == False:
        ...
        # If the solution hasn't been found, and the frontier runs out of options, there is no solution.
